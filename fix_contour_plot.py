...
# Draw contour plot with filled colors only (no white lines)
contour = plt.contourf(x, y, z, 35, cmap=custom_cmap)
# No contour lines - removed to avoid white lines between color regions
...
print("Contour plot with labels generated successfully at public/images/contour_plot_background.png")