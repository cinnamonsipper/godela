...
import { Send, PlusCircle, GripVertical, Sliders, Maximize2, MinusCircle, PlusCircle as Plus } from 'lucide-react';
...
/**
 * Latent Explorer Demo Component - Final Version
 * 
 ...
 * 
 * Integrates a proper latent space explorer with the aircraft model as the focal point.
 */
export default function LatentExplorerDemo({ onStepComplete, expectedResponse = '' }: {
  ...
  // New latent space explorer state
          ...
          <div className="h-full w-full flex items-center justify-center">
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <img 
                  src="https://images.unsplash.com/photo-1540555700478-4be289fbecef?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2940&q=80" 
                  alt="Aircraft Model"
              ...
              {explorerPhase === 4 && (
                <motion.div
                  ...
                  className="absolute top-8 right-8 bg-green-900/20 backdrop-blur-md p-4 border border-green-500/30 rounded-xl max-w-[280px]"
                >
