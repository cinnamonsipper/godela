...
# Draw ONLY filled contours - DO NOT add contour lines to avoid white lines
plt.contourf(x, y, z, 35, cmap=custom_cmap)
...
print("Contour plot with NO WHITE LINES generated successfully at public/images/contour_plot_background.png")